...
if __name__ == '__main__':
	...
	answers, answers_to_test = digits.target[:1500], digits.target[1500:]
	sliced_digits, unlearned_digits = digits.data[:1500], digits.data[1500:]
	weights = learn_nums(sliced_digits, answers)
	results = run_blind_data(unlearned_digits, answers_to_test, weights)
	print("Computer was right {} times out of {}".format(results[0], len(digits.data)-1500))
